...
\centering
    \includegraphics<1>[width=.6\textwidth]{./figs/fitumap/epoch0.png}%
    \includegraphics<2>[width=.6\textwidth]{./figs/fitumap/epoch1.png}%
    \includegraphics<3>[width=.6\textwidth]{./figs/fitumap/epoch2.png}%
    \includegraphics<4>[width=.6\textwidth]{./figs/fitumap/epoch3.png}%
    \includegraphics<5>[width=.6\textwidth]{./figs/fitumap/epoch4.png}%
    \includegraphics<6>[width=.6\textwidth]{./figs/fitumap/epoch5.png}%
\end{frame}
